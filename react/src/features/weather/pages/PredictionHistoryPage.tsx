  ...
  return (
    <div style={{ padding: '0.5rem 0' }}>
      ...
      <div className="ae-hero-band">
        <div className="ae-eyebrow">WEATHER INTELLIGENCE &bull; AUDIT TRAIL</div>
        <h2 className="ae-headline">📜 Alert &amp; Prediction History</h2>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
            <thead>
              <tr style={{ background: '#f8fafc', borderBottom: '2px solid #e2e8f0' }}>
                {['Hazard', 'District', 'Severity', 'Status', 'Created At', 'Published At'].map(h => (
